...
export function mountStackTestingLab() {
  ...
  function updateExports() {
    const payload = {
      component: STACK_TESTING_SPEC.name,
      figmaNodeId: STACK_TESTING_SPEC.figmaNodeId,
      variant: `state=${appState.activeIndex + 1}`,
      transition: {
        type: appState.settings.transitionType,
        ease: appState.settings.easeName,
        duration: appState.settings.duration,
        imageShift: appState.settings.imageShift,
        indicatorDuration: appState.settings.indicatorDuration
      }
    };
  ...
  function hydrateFromUrl() {
    ...
    applyNumberParam(params, "shift", "imageShift", 0, 64);
    applyNumberParam(params, "idur", "indicatorDuration", 0, 1.5);
  }
  ...
  function updateUrl() {
    ...
    params.set("dur", String(appState.settings.duration));
    params.set("shift", String(appState.settings.imageShift));
    params.set("idur", String(appState.settings.indicatorDuration));
    writeParams(params);
  }
